...
#ifdef CreateTree_cxx
CreateTree::CreateTree(TTree *tree) : fChain(0) 
{
...
Int_t CreateTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CreateTree::LoadTree(Long64_t entry)
{
...
void CreateTree::Init(TTree *tree)
{
...
void CreateTree::Show(Long64_t entry)
{
...
Int_t CreateTree::Cut(Long64_t entry)
{
