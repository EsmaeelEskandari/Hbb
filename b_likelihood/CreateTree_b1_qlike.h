...
// Thu Aug 13 18:21:12 2015 by ROOT version 5.34/32
// from TTree tree/PhysicsTools.Heppy.analyzers.core.AutoFillTreeProducer.AutoFillTreeProducer_1
// found on file: ../MC_new/VBFHToBB_M-125_13TeV_powheg_pythia8/tree.root
//////////////////////////////////////////////////////////

#ifndef CreateTree_b1_qlike_h
#define CreateTree_b1_qlike_h
...
public :
   ...
   CreateTree_b1_qlike(TTree *tree=0);
   virtual ~CreateTree_b1_qlike();
...
#ifdef CreateTree_b1_qlike_cxx
CreateTree_b1_qlike::CreateTree_b1_qlike(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../MC_new/VBFHToBB_M-125_13TeV_powheg_pythia8/tree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../MC_new/VBFHToBB_M-125_13TeV_powheg_pythia8/tree.root");
      }
...
CreateTree_b1_qlike::~CreateTree_b1_qlike()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CreateTree_b1_qlike::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CreateTree_b1_qlike::LoadTree(Long64_t entry)
{
...
void CreateTree_b1_qlike::Init(TTree *tree)
{
...
Bool_t CreateTree_b1_qlike::Notify()
{
...
void CreateTree_b1_qlike::Show(Long64_t entry)
{
...
Int_t CreateTree_b1_qlike::Cut(Long64_t entry)
{
...
#endif // #ifdef CreateTree_b1_qlike_cxx
