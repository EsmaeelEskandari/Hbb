...
// Thu Aug 13 10:26:03 2015 by ROOT version 5.34/32
...
#ifndef CreateTree_qlike_h
#define CreateTree_qlike_h
...
public :
   ...
   CreateTree_qlike(TTree *tree=0);
   virtual ~CreateTree_qlike();
...
#ifdef CreateTree_qlike_cxx
CreateTree_qlike::CreateTree_qlike(TTree *tree) : fChain(0) 
{
...
CreateTree_qlike::~CreateTree_qlike()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CreateTree_qlike::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CreateTree_qlike::LoadTree(Long64_t entry)
{
...
void CreateTree_qlike::Init(TTree *tree)
{
...
Bool_t CreateTree_qlike::Notify()
{
...
void CreateTree_qlike::Show(Long64_t entry)
{
...
Int_t CreateTree_qlike::Cut(Long64_t entry)
{
...
#endif // #ifdef CreateTree_qlike_cxx
