...
//	TString s_names[num_ss] = {"VBFHToBB_M-125_13TeV_powheg","GF"};
	TString s_names[num_ss] = {"VBFHToBB_M-125","GluGluHToBB_M-125"};
//	TString s_names[num_ss] = {"vbf_76"};
	...
	ofstream out;
	out.open("output_txt/v21/sysUnc_"+s_names[sig_num]+type+"_pdf_cat.txt");
	out <<"Systematic uncertainties pdf scale for "<<type<<"  "<<" "<<s_names[sig_num]<<"  " <<endl;



	TCanvas *c0 = new TCanvas();
//	TFile *file_nom =  new TFile("/mnt/t3nfs01/data01/shome/nchernya/Hbb/plotter/pdf_unc/"+s_names[sig_num]+"_analysis"+type+"_trignom_v21_pdf_pdf_unc.root");
	TFile *file_nom =  new TFile(s_names[sig_num]+"_analysis"+type+"_trignom_v21_pdf_pdf_unc.root");
	TH1F *hist[10];
...
////////
	...
	c1->Print("plots/v21/v21_"+s_names[sig_num]+type+"_pdf_cat"+tmp_str_num.Format("\%d",cat_num).Data()+".png");
