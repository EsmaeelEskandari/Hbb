...
TString file_names[nfiles] = {"QCD_HT100to200", "QCD_HT200to300", "QCD_HT300to500","QCD_HT500to700", "QCD_HT700to1000", "QCD_HT1000to1500", "QCD_HT1500to2000", "QCD_HT2000toInf", "VBFHToBB_M-125_13TeV_powheg", "VBFHToBB_M-130_13TeV_powheg", "BTagCSV"};
...
Double_t xsec[nfiles] = { 2.75E07, 1.74E06,  3.67E05, 2.94E04, 6.52E03,1.064E03,   121.5,  2.54E01,2.16 ,1.96,1.};
...
do {
	...
	file_initial = new TFile(path+file_names[files]+"_v14"+dataset_type[set_type]+"/"+file_names[files]+file_postfix[set_type]+dataset_type[set_type]+".root");
	...
	hJet2q_mult->GetXaxis()->SetTitle("Multiplicity of second quark jet candidate");
   		...
   		const int numArray= 64; //54 without qgl stuff
...
///////// preselection(Int_t nJets, Float_t Jet_pt[300], Float_t Jet_eta[300], Float_t Jet_phi[300], Float_t Jet_mass[300], Float_t Jet_btagCSV[300], Int_t id[300], Int_t& btag_max1_number, Int_t& btag_max2_number, Int_t& pt_max1_number, Int_t& pt_max2_number, Float_t trigger, TLorentzVector& Bjet1,TLorentzVector& Bjet2, TLorentzVector& Qjet1, TLorentzVector& Qjet2,TLorentzVector& qq, Float_t scale=1.)
	...
	//			cout<<"second quark jet candidate, entry =  "<< entry<< "  , ptd = "<< Jet.ptd[pt_max2_number]<< " , axis2 = "<<Jet.axis2[pt_max2_number]<<" , mult = " << Jet.mult[pt_max2_number]<< " , qgl = "<<Jet.qgl[pt_max2_number]<<endl;
		...
		TFile file("output_hist/v14/skimmed_tree"+dataset_type[set_type]+type[files]+"_v14.root","recreate");
		...
		for (int i=0;i<numArray;++i){
    		...
    		file.Write();
    		file.Close();
	 ofstream out("output_txt/v14/skimmed"+dataset_type[set_type]+type[files]+"_v14.txt");
