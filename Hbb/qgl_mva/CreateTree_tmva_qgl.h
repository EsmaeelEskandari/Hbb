...
#ifndef CreateTree_tmva_qgl_h
#define CreateTree_tmva_qgl_h
...
public :
   ...
   CreateTree_tmva_qgl(TTree *tree=0, TString filename="");
   virtual ~CreateTree_tmva_qgl();
...
#ifdef CreateTree_tmva_qgl_cxx
CreateTree_tmva_qgl::CreateTree_tmva_qgl(TTree *tree, TString filename) : fChain(0) 
{
   if (tree == 0) {
			file_name = filename;
...
CreateTree_tmva_qgl::~CreateTree_tmva_qgl()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CreateTree_tmva_qgl::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CreateTree_tmva_qgl::LoadTree(Long64_t entry)
{
...
void CreateTree_tmva_qgl::Init(TTree *tree)
{
...
Bool_t CreateTree_tmva_qgl::Notify()
{
...
void CreateTree_tmva_qgl::Show(Long64_t entry)
{
...
Int_t CreateTree_tmva_qgl::Cut(Long64_t entry)
{
...
#endif // #ifdef CreateTree_tmva_qgl_cxx
