#define CreateTree_b1_qlike_cxx
#include "CreateTree_b1_qlike.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void CreateTree_b1_qlike::Loop()
{
   ...
   Long64_t nbytes = 0, nb = 0;
	...
	TFile file("spring15_vbf_powheg_new_qlike_125_single_08_singlebtag.root","recreate");
...
/*
	...
	ofstream out("spring15_powheg_125_08_singlebtagi_qqlike.txt"); 
