...
// Sun Oct  4 12:12:28 2015 by ROOT version 5.34/32
// from TTree tree/PhysicsTools.Heppy.analyzers.core.AutoFillTreeProducer.AutoFillTreeProducer_1
// found on file: VBFHToBB_M-125_13TeV_powheg_pythia8_weightfix_v13.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   ...
   //   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/user/n/nchernya/Hbb/CMSSW_7_4_7_patch1/src/VHbbAnalysis/Heppy/test/crab/crab_projects_blike_debug_final_3/crab_vhbb_heppy_blike_debug_final_3/results/tree.root");
   TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/n/nchernya/Hbb/V13/VBFHToBB_M-125_13TeV_powheg_pythia8_weightfix_v13.root");
      if (!f || !f->IsOpen()) {
         //f = new TFile("/afs/cern.ch/work/n/nchernya/Hbb/MC_new/VBFHToBB_M-125_13TeV_powheg_pythia8/tree.root");
     //    f = new TFile("/afs/cern.ch/user/n/nchernya/Hbb/CMSSW_7_4_7_patch1/src/VHbbAnalysis/Heppy/test/crab/crab_projects_blike_debug_final_3/crab_vhbb_heppy_blike_debug_final_3/results/tree.root");
     			f = new TFile("/afs/cern.ch/work/n/nchernya/Hbb/V13/VBFHToBB_M-125_13TeV_powheg_pythia8_weightfix_v13.root");
      }
...
void CreateTree_b1::Init(TTree *tree)
{
   ...
   // a new tree or chain. Typically here the CreateTree_b1 addresses and CreateTree_b1
   ...
   // Set CreateTree_b1 addresses and CreateTree_b1 pointers
   if (!tree) return;
   fChain = tree;
   fCurrent = -1;
