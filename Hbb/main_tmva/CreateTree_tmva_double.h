...
// Wed Jul 29 14:12:35 2015 by ROOT version 5.34/30
...
public :
   ...
   CreateTree_tmva_double(TTree *tree=0, int sample_type=0);
   virtual ~CreateTree_tmva_double();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(int sample_type=0);
...
CreateTree_tmva_double::CreateTree_tmva_double(TTree *tree, int sample_type) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/n/nchernya/Hbb/Spring15_vhbb_sisters_powheg_tree.root");
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/n/nchernya/Hbb/MC_new/Spring15_M125_powheg_Asympt25ns.root");
      //	TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/n/nchernya/Hbb/MC_new/VBFHToBB_M125_13TeV_amcatnlo_pythia8__RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1/tree.root");
      	//TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/n/nchernya/Hbb/MC_new/VBFHToBB_M-130_13TeV_powheg_pythia8__RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v2/tree.root");
			if (sample_type==0) file_name = "/afs/cern.ch/work/n/nchernya/Hbb/MC_new/VBFHToBB_M-125_13TeV_powheg_pythia8/tree.root";
			if (sample_type==1) file_name = "/afs/cern.ch/work/n/nchernya/Hbb/MC_new/QCD_HT300to500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8__RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v2/tree.root";
      	TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject(file_name);
      if (!f || !f->IsOpen()) {
      //  f = new TFile("/afs/cern.ch/work/n/nchernya/Hbb/Spring15_vhbb_sisters_powheg_tree.root");
      	  //f = new TFile("/afs/cern.ch/work/n/nchernya/Hbb/MC_new/Spring15_M125_powheg_Asympt25ns.root");
      //	  f = new TFile("/afs/cern.ch/work/n/nchernya/Hbb/MC_new/VBFHToBB_M125_13TeV_amcatnlo_pythia8__RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v1/tree.root");
      //	f = new TFile("/afs/cern.ch/work/n/nchernya/Hbb/MC_new/VBFHToBB_M-130_13TeV_powheg_pythia8__RunIISpring15DR74-Asympt25ns_MCRUN2_74_V9-v2/tree.root");
