...
void MakeB_single::Init(TTree *tree)
{
   ...
   // a new tree or chain. Typically here the MakeB_single addresses and MakeB_single
   ...
   // Set MakeB_single addresses and MakeB_single pointers
   if (!tree) return;
   fChain = tree;
   fCurrent = -1;
