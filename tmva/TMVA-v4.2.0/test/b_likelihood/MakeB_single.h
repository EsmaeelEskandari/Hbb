...
// Thu Mar  3 16:29:45 2016 by ROOT version 5.34/18
// from TTree tree/PhysicsTools.Heppy.analyzers.core.AutoFillTreeProducer.AutoFillTreeProducer_1
// found on file: MakeB_single.root
//////////////////////////////////////////////////////////

#ifndef MakeB_single_h
#define MakeB_single_h
...
public :
   ...
   Float_t         vLeptons_eleMVArawPhys14NonTrig[2];   //[nvLeptons]
   Int_t           vLeptons_eleMVAIdPhys14NonTrig[2];   //[nvLeptons]
   ...
   Float_t         vLeptons_SF_HLT[2];   //[nvLeptons]
   Float_t         vLeptons_SFerr_HLT[2];   //[nvLeptons]
   ...
   Float_t         vLeptons_SF_IdLoose[2];   //[nvLeptons]
   Float_t         vLeptons_SFerr_IdLoose[2];   //[nvLeptons]
   Float_t         vLeptons_SF_IdTight[2];   //[nvLeptons]
   Float_t         vLeptons_SFerr_IdTight[2];   //[nvLeptons]
   Float_t         vLeptons_Eff_HLT[2];   //[nvLeptons]
   Float_t         vLeptons_Efferr_HLT[2];   //[nvLeptons]
   ...
   Float_t         FatjetCA15ungroomed_numberOfDaughters[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_neutralEmEnergyFraction[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_neutralHadronEnergyFraction[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_muonEnergyFraction[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_chargedEmEnergyFraction[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_chargedHadronEnergyFraction[4];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_chargedMultiplicity[4];   //[nFatjetCA15ungroomed]
   ...
   Float_t         aLeptons_eleMVArawPhys14NonTrig[8];   //[naLeptons]
   Int_t           aLeptons_eleMVAIdPhys14NonTrig[8];   //[naLeptons]
   ...
   Float_t         aLeptons_SF_HLT[8];   //[naLeptons]
   Float_t         aLeptons_SFerr_HLT[8];   //[naLeptons]
   ...
   Float_t         aLeptons_SF_IdLoose[8];   //[naLeptons]
   Float_t         aLeptons_SFerr_IdLoose[8];   //[naLeptons]
   Float_t         aLeptons_SF_IdTight[8];   //[naLeptons]
   Float_t         aLeptons_SFerr_IdTight[8];   //[naLeptons]
   Float_t         aLeptons_Eff_HLT[8];   //[naLeptons]
   Float_t         aLeptons_Efferr_HLT[8];   //[naLeptons]
   ...
   Float_t         FatjetAK08ungroomed_mprunedcorr[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_JEC_L2L3[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_JEC_L1L2L3[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_bbtag[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_id_Tight[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_numberOfDaughters[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_neutralEmEnergyFraction[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_neutralHadronEnergyFraction[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_muonEnergyFraction[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_chargedEmEnergyFraction[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_chargedHadronEnergyFraction[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_chargedMultiplicity[6];   //[nFatjetAK08ungroomed]
   Int_t           FatjetAK08ungroomed_Flavour[6];   //[nFatjetAK08ungroomed]
   Int_t           FatjetAK08ungroomed_BhadronFlavour[6];   //[nFatjetAK08ungroomed]
   Int_t           FatjetAK08ungroomed_ChadronFlavour[6];   //[nFatjetAK08ungroomed]
   Float_t         FatjetAK08ungroomed_GenPt[6];   //[nFatjetAK08ungroomed]
   ...
   Float_t         selLeptons_eleMVArawPhys14NonTrig[3];   //[nselLeptons]
   Int_t           selLeptons_eleMVAIdPhys14NonTrig[3];   //[nselLeptons]
   ...
   Float_t         selLeptons_SF_HLT[3];   //[nselLeptons]
   Float_t         selLeptons_SFerr_HLT[3];   //[nselLeptons]
   ...
   Float_t         selLeptons_SF_IdLoose[3];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdLoose[3];   //[nselLeptons]
   Float_t         selLeptons_SF_IdTight[3];   //[nselLeptons]
   Float_t         selLeptons_SFerr_IdTight[3];   //[nselLeptons]
   Float_t         selLeptons_Eff_HLT[3];   //[nselLeptons]
   Float_t         selLeptons_Efferr_HLT[3];   //[nselLeptons]
   ...
   Int_t           Jet_mcMatchId[17];   //[nJet]
   Float_t         Jet_corr_JECUp[17];   //[nJet]
   Float_t         Jet_corr_JECDown[17];   //[nJet]
   Float_t         Jet_corr[17];   //[nJet]
   Float_t         Jet_corr_JERUp[17];   //[nJet]
   Float_t         Jet_corr_JERDown[17];   //[nJet]
   Float_t         Jet_corr_JER[17];   //[nJet]
   ...
   Int_t           Jet_heppyFlavour[17];   //[nJet]
   ...
   Float_t         Jet_mcEta[17];   //[nJet]
   Float_t         Jet_mcPhi[17];   //[nJet]
   Float_t         Jet_mcM[17];   //[nJet]
   ...
   Float_t         Jet_bTagWeightJESUp[17];   //[nJet]
   Float_t         Jet_bTagWeightJESDown[17];   //[nJet]
   Float_t         Jet_bTagWeightLFUp[17];   //[nJet]
   Float_t         Jet_bTagWeightLFDown[17];   //[nJet]
   Float_t         Jet_bTagWeightHFUp[17];   //[nJet]
   Float_t         Jet_bTagWeightHFDown[17];   //[nJet]
   Float_t         Jet_bTagWeightHFStats1Up[17];   //[nJet]
   Float_t         Jet_bTagWeightHFStats1Down[17];   //[nJet]
   Float_t         Jet_bTagWeightHFStats2Up[17];   //[nJet]
   Float_t         Jet_bTagWeightHFStats2Down[17];   //[nJet]
   Float_t         Jet_bTagWeightLFStats1Up[17];   //[nJet]
   Float_t         Jet_bTagWeightLFStats1Down[17];   //[nJet]
   Float_t         Jet_bTagWeightLFStats2Up[17];   //[nJet]
   Float_t         Jet_bTagWeightLFStats2Down[17];   //[nJet]
   Float_t         Jet_bTagWeightcErr1Up[17];   //[nJet]
   Float_t         Jet_bTagWeightcErr1Down[17];   //[nJet]
   Float_t         Jet_bTagWeightcErr2Up[17];   //[nJet]
   Float_t         Jet_bTagWeightcErr2Down[17];   //[nJet]
   Float_t         Jet_bTagWeight[17];   //[nJet]
   Float_t         Jet_btagCSVLSF[17];   //[nJet]
   Float_t         Jet_btagCSVLSF_Up[17];   //[nJet]
   Float_t         Jet_btagCSVLSF_Down[17];   //[nJet]
   Float_t         Jet_btagCSVMSF[17];   //[nJet]
   Float_t         Jet_btagCSVMSF_Up[17];   //[nJet]
   Float_t         Jet_btagCSVMSF_Down[17];   //[nJet]
   Float_t         Jet_btagCSVTSF[17];   //[nJet]
   Float_t         Jet_btagCSVTSF_Up[17];   //[nJet]
   Float_t         Jet_btagCSVTSF_Down[17];   //[nJet]
   Float_t         Jet_btagCMVAV2LSF[17];   //[nJet]
   Float_t         Jet_btagCMVAV2LSF_Up[17];   //[nJet]
   Float_t         Jet_btagCMVAV2LSF_Down[17];   //[nJet]
   Float_t         Jet_btagCMVAV2MSF[17];   //[nJet]
   Float_t         Jet_btagCMVAV2MSF_Up[17];   //[nJet]
   Float_t         Jet_btagCMVAV2MSF_Down[17];   //[nJet]
   Float_t         Jet_btagCMVAV2TSF[17];   //[nJet]
   Float_t         Jet_btagCMVAV2TSF_Up[17];   //[nJet]
   Float_t         Jet_btagCMVAV2TSF_Down[17];   //[nJet]
   ...
   TBranch        *b_vLeptons_eleMVArawPhys14NonTrig;   //!
   TBranch        *b_vLeptons_eleMVAIdPhys14NonTrig;   //!
   ...
   TBranch        *b_vLeptons_SF_HLT;   //!
   TBranch        *b_vLeptons_SFerr_HLT;   //!
   ...
   TBranch        *b_vLeptons_SF_IdLoose;   //!
   TBranch        *b_vLeptons_SFerr_IdLoose;   //!
   TBranch        *b_vLeptons_SF_IdTight;   //!
   TBranch        *b_vLeptons_SFerr_IdTight;   //!
   TBranch        *b_vLeptons_Eff_HLT;   //!
   TBranch        *b_vLeptons_Efferr_HLT;   //!
   ...
   TBranch        *b_FatjetCA15ungroomed_numberOfDaughters;   //!
   TBranch        *b_FatjetCA15ungroomed_neutralEmEnergyFraction;   //!
   TBranch        *b_FatjetCA15ungroomed_neutralHadronEnergyFraction;   //!
   TBranch        *b_FatjetCA15ungroomed_muonEnergyFraction;   //!
   TBranch        *b_FatjetCA15ungroomed_chargedEmEnergyFraction;   //!
   TBranch        *b_FatjetCA15ungroomed_chargedHadronEnergyFraction;   //!
   TBranch        *b_FatjetCA15ungroomed_chargedMultiplicity;   //!
   ...
   TBranch        *b_aLeptons_eleMVArawPhys14NonTrig;   //!
   TBranch        *b_aLeptons_eleMVAIdPhys14NonTrig;   //!
   ...
   TBranch        *b_aLeptons_SF_HLT;   //!
   TBranch        *b_aLeptons_SFerr_HLT;   //!
   ...
   TBranch        *b_aLeptons_SF_IdLoose;   //!
   TBranch        *b_aLeptons_SFerr_IdLoose;   //!
   TBranch        *b_aLeptons_SF_IdTight;   //!
   TBranch        *b_aLeptons_SFerr_IdTight;   //!
   TBranch        *b_aLeptons_Eff_HLT;   //!
   TBranch        *b_aLeptons_Efferr_HLT;   //!
   ...
   TBranch        *b_selLeptons_eleMVArawPhys14NonTrig;   //!
   TBranch        *b_selLeptons_eleMVAIdPhys14NonTrig;   //!
   ...
   TBranch        *b_selLeptons_SF_HLT;   //!
   TBranch        *b_selLeptons_SFerr_HLT;   //!
   ...
   TBranch        *b_selLeptons_SF_IdLoose;   //!
   TBranch        *b_selLeptons_SFerr_IdLoose;   //!
   TBranch        *b_selLeptons_SF_IdTight;   //!
   TBranch        *b_selLeptons_SFerr_IdTight;   //!
   TBranch        *b_selLeptons_Eff_HLT;   //!
   TBranch        *b_selLeptons_Efferr_HLT;   //!
   ...
   MakeB_single(TTree *tree=0);
   virtual ~MakeB_single();
...
#ifdef MakeB_single_cxx
MakeB_single::MakeB_single(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/n/nchernya/Hbb/skim_trees/v14/vbf_v21b/vbf_v21b.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/n/nchernya/Hbb/skim_trees/v14/vbf_v21b/vbf_v21b.root");
      }
...
MakeB_single::~MakeB_single()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MakeB_single::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MakeB_single::LoadTree(Long64_t entry)
{
...
void MakeB_single::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("vLeptons_eleMVArawPhys14NonTrig", vLeptons_eleMVArawPhys14NonTrig, &b_vLeptons_eleMVArawPhys14NonTrig);
   fChain->SetBranchAddress("vLeptons_eleMVAIdPhys14NonTrig", vLeptons_eleMVAIdPhys14NonTrig, &b_vLeptons_eleMVAIdPhys14NonTrig);
   ...
   fChain->SetBranchAddress("vLeptons_SF_HLT", vLeptons_SF_HLT, &b_vLeptons_SF_HLT);
   fChain->SetBranchAddress("vLeptons_SFerr_HLT", vLeptons_SFerr_HLT, &b_vLeptons_SFerr_HLT);
   ...
   fChain->SetBranchAddress("vLeptons_SF_IdLoose", vLeptons_SF_IdLoose, &b_vLeptons_SF_IdLoose);
   fChain->SetBranchAddress("vLeptons_SFerr_IdLoose", vLeptons_SFerr_IdLoose, &b_vLeptons_SFerr_IdLoose);
   fChain->SetBranchAddress("vLeptons_SF_IdTight", vLeptons_SF_IdTight, &b_vLeptons_SF_IdTight);
   fChain->SetBranchAddress("vLeptons_SFerr_IdTight", vLeptons_SFerr_IdTight, &b_vLeptons_SFerr_IdTight);
   fChain->SetBranchAddress("vLeptons_Eff_HLT", vLeptons_Eff_HLT, &b_vLeptons_Eff_HLT);
   fChain->SetBranchAddress("vLeptons_Efferr_HLT", vLeptons_Efferr_HLT, &b_vLeptons_Efferr_HLT);
   ...
   fChain->SetBranchAddress("FatjetCA15ungroomed_numberOfDaughters", FatjetCA15ungroomed_numberOfDaughters, &b_FatjetCA15ungroomed_numberOfDaughters);
   fChain->SetBranchAddress("FatjetCA15ungroomed_neutralEmEnergyFraction", FatjetCA15ungroomed_neutralEmEnergyFraction, &b_FatjetCA15ungroomed_neutralEmEnergyFraction);
   fChain->SetBranchAddress("FatjetCA15ungroomed_neutralHadronEnergyFraction", FatjetCA15ungroomed_neutralHadronEnergyFraction, &b_FatjetCA15ungroomed_neutralHadronEnergyFraction);
   fChain->SetBranchAddress("FatjetCA15ungroomed_muonEnergyFraction", FatjetCA15ungroomed_muonEnergyFraction, &b_FatjetCA15ungroomed_muonEnergyFraction);
   fChain->SetBranchAddress("FatjetCA15ungroomed_chargedEmEnergyFraction", FatjetCA15ungroomed_chargedEmEnergyFraction, &b_FatjetCA15ungroomed_chargedEmEnergyFraction);
   fChain->SetBranchAddress("FatjetCA15ungroomed_chargedHadronEnergyFraction", FatjetCA15ungroomed_chargedHadronEnergyFraction, &b_FatjetCA15ungroomed_chargedHadronEnergyFraction);
   fChain->SetBranchAddress("FatjetCA15ungroomed_chargedMultiplicity", FatjetCA15ungroomed_chargedMultiplicity, &b_FatjetCA15ungroomed_chargedMultiplicity);
   ...
   fChain->SetBranchAddress("aLeptons_eleMVArawPhys14NonTrig", aLeptons_eleMVArawPhys14NonTrig, &b_aLeptons_eleMVArawPhys14NonTrig);
   fChain->SetBranchAddress("aLeptons_eleMVAIdPhys14NonTrig", aLeptons_eleMVAIdPhys14NonTrig, &b_aLeptons_eleMVAIdPhys14NonTrig);
   ...
   fChain->SetBranchAddress("aLeptons_SF_HLT", aLeptons_SF_HLT, &b_aLeptons_SF_HLT);
   fChain->SetBranchAddress("aLeptons_SFerr_HLT", aLeptons_SFerr_HLT, &b_aLeptons_SFerr_HLT);
   ...
   fChain->SetBranchAddress("aLeptons_SF_IdLoose", aLeptons_SF_IdLoose, &b_aLeptons_SF_IdLoose);
   fChain->SetBranchAddress("aLeptons_SFerr_IdLoose", aLeptons_SFerr_IdLoose, &b_aLeptons_SFerr_IdLoose);
   fChain->SetBranchAddress("aLeptons_SF_IdTight", aLeptons_SF_IdTight, &b_aLeptons_SF_IdTight);
   fChain->SetBranchAddress("aLeptons_SFerr_IdTight", aLeptons_SFerr_IdTight, &b_aLeptons_SFerr_IdTight);
   fChain->SetBranchAddress("aLeptons_Eff_HLT", aLeptons_Eff_HLT, &b_aLeptons_Eff_HLT);
   fChain->SetBranchAddress("aLeptons_Efferr_HLT", aLeptons_Efferr_HLT, &b_aLeptons_Efferr_HLT);
   ...
   fChain->SetBranchAddress("selLeptons_eleMVArawPhys14NonTrig", selLeptons_eleMVArawPhys14NonTrig, &b_selLeptons_eleMVArawPhys14NonTrig);
   fChain->SetBranchAddress("selLeptons_eleMVAIdPhys14NonTrig", selLeptons_eleMVAIdPhys14NonTrig, &b_selLeptons_eleMVAIdPhys14NonTrig);
   ...
   fChain->SetBranchAddress("selLeptons_SF_HLT", selLeptons_SF_HLT, &b_selLeptons_SF_HLT);
   fChain->SetBranchAddress("selLeptons_SFerr_HLT", selLeptons_SFerr_HLT, &b_selLeptons_SFerr_HLT);
   ...
   fChain->SetBranchAddress("selLeptons_SF_IdLoose", selLeptons_SF_IdLoose, &b_selLeptons_SF_IdLoose);
   fChain->SetBranchAddress("selLeptons_SFerr_IdLoose", selLeptons_SFerr_IdLoose, &b_selLeptons_SFerr_IdLoose);
   fChain->SetBranchAddress("selLeptons_SF_IdTight", selLeptons_SF_IdTight, &b_selLeptons_SF_IdTight);
   fChain->SetBranchAddress("selLeptons_SFerr_IdTight", selLeptons_SFerr_IdTight, &b_selLeptons_SFerr_IdTight);
   fChain->SetBranchAddress("selLeptons_Eff_HLT", selLeptons_Eff_HLT, &b_selLeptons_Eff_HLT);
   fChain->SetBranchAddress("selLeptons_Efferr_HLT", selLeptons_Efferr_HLT, &b_selLeptons_Efferr_HLT);
...
void MakeB_single::Show(Long64_t entry)
{
...
Int_t MakeB_single::Cut(Long64_t entry)
{
