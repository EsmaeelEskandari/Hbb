...
void TMVAClassification_blikelihood( TString myMethodList = "" )
{
 ...
 //  TString outfileName( "TMVA_bjet_new_powheg.root" );
   TString outfileName( "TMVA_blike_singlebtag_final_fixed.root" );
 ...
 //  factory->AddVariable( "Jet_axis2", "Jet axis 2", "", 'F' );
  ...
  // factory->AddSpectator( "spec2 := var1*3",  "Spectator 2", "units", 'F' );
   ...
   // (it is also possible to use ASCII format as input -> see TMVA Users Guide)
	TString fname = "/afs/cern.ch/work/n/nchernya/Hbb/b_likelihood/spring15_vbf_powheg_new_blike_125_singlebtag_final_fixed.root"; 
