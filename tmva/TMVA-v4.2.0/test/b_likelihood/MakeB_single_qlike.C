#define MakeB_single_qlike_cxx
#include "MakeB_single_qlike.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
void MakeB_single_qlike::Loop()
{
   ...
   Long64_t nbytes = 0, nb = 0;
	...
	TreeJets TreeJet;
	Int_t loopJet_max;
	TFile *output = new TFile("b_likelihood_powheg_6var_bbqq_125_08_single_qlike.root","recreate");
...
//	TString weightfile_b = "weights/TMVAClassification_BDTG_6var_bb_125_08_single.weights.xml";
	TString weightfile_q = "weights/TMVAClassification_BDTG_6var_qq_125_08_single_qlike.weights.xml";
