...
// Tue Aug 11 16:12:23 2015 by ROOT version 5.34/32
// from TTree tree/PhysicsTools.Heppy.analyzers.core.AutoFillTreeProducer.AutoFillTreeProducer_1
// found on file: ../b_likelihood_powheg_6var_bbqq.root
//////////////////////////////////////////////////////////
...
#ifdef plotM2_cxx
plotM2::plotM2(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../b_likelihood_powheg_6var_bbqq.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../b_likelihood_powheg_6var_bbqq.root");
      }
...
Int_t plotM2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t plotM2::LoadTree(Long64_t entry)
{
...
void plotM2::Show(Long64_t entry)
{
...
Int_t plotM2::Cut(Long64_t entry)
{
