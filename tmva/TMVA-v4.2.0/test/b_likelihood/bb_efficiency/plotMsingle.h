...
// found on file: plotMsingle.root
//////////////////////////////////////////////////////////

#ifndef plotMsingle_h
#define plotMsingle_h
...
public :
   ...
   Float_t         Jet_blikelihood_b[15];   //[nJet]
...
#ifdef plotMsingle_cxx
plotMsingle::plotMsingle(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../blikelihood_vbf_singlebtag_cmssw76_h21btrained.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../blikelihood_vbf_singlebtag_cmssw76_h21btrained.root");
      }
...
plotMsingle::~plotMsingle()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t plotMsingle::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t plotMsingle::LoadTree(Long64_t entry)
{
...
void plotMsingle::Init(TTree *tree)
{
...
void plotMsingle::Show(Long64_t entry)
{
...
Int_t plotMsingle::Cut(Long64_t entry)
{
