...
// Wed Jul 29 15:26:31 2015 by ROOT version 5.34/30
...
#ifdef MakeB_cxx
MakeB::MakeB(TTree *tree) : fChain(0) 
{
...
Int_t MakeB::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MakeB::LoadTree(Long64_t entry)
{
...
void MakeB::Show(Long64_t entry)
{
...
Int_t MakeB::Cut(Long64_t entry)
{
