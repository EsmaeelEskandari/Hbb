...
// Thu Aug 13 10:40:51 2015 by ROOT version 5.34/32
...
#ifndef MakeB_qlike_h
#define MakeB_qlike_h
...
#ifdef MakeB_qlike_cxx
MakeB_qlike::MakeB_qlike(TTree *tree) : fChain(0) 
{
...
MakeB_qlike::~MakeB_qlike()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MakeB_qlike::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MakeB_qlike::LoadTree(Long64_t entry)
{
...
void MakeB_qlike::Init(TTree *tree)
{
...
void MakeB_qlike::Show(Long64_t entry)
{
...
Int_t MakeB_qlike::Cut(Long64_t entry)
{
