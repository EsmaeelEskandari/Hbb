...
#ifndef TMVAapply_double_h
#define TMVAapply_double_h
...
public :
   ...
   TMVAapply_double(TTree *tree=0, TString filename="");
   virtual ~TMVAapply_double();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TString inputfile="", TString output_dir="", int sample_type=0);
...
#ifdef TMVAapply_double_cxx
TMVAapply_double::TMVAapply_double(TTree *tree, TString filename) : fChain(0) 
{
   if (tree == 0) {
			file_name = filename;
...
TMVAapply_double::~TMVAapply_double()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TMVAapply_double::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TMVAapply_double::LoadTree(Long64_t entry)
{
...
void TMVAapply_double::Init(TTree *tree)
{
...
Bool_t TMVAapply_double::Notify()
{
...
void TMVAapply_double::Show(Long64_t entry)
{
...
Int_t TMVAapply_double::Cut(Long64_t entry)
{
...
#endif // #ifdef TMVAapply_double_cxx
