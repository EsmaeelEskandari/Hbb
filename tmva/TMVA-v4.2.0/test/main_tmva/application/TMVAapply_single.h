...
#ifndef TMVAapply_single_h
#define TMVAapply_single_h
...
public :
   ...
   TMVAapply_single(TTree *tree=0, TString filename="");
   virtual ~TMVAapply_single();
...
#ifdef TMVAapply_single_cxx
TMVAapply_single::TMVAapply_single(TTree *tree, TString filename) : fChain(0) 
{
   if (tree == 0) {
			file_name = filename;
...
TMVAapply_single::~TMVAapply_single()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TMVAapply_single::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TMVAapply_single::LoadTree(Long64_t entry)
{
...
void TMVAapply_single::Init(TTree *tree)
{
...
Bool_t TMVAapply_single::Notify()
{
...
void TMVAapply_single::Show(Long64_t entry)
{
...
Int_t TMVAapply_single::Cut(Long64_t entry)
{
...
#endif // #ifdef TMVAapply_single_cxx
