...
// Fri Aug  7 13:50:42 2015 by ROOT version 5.34/32
// from TTree tree/PhysicsTools.Heppy.analyzers.core.AutoFillTreeProducer.AutoFillTreeProducer_1
// found on file: b_likelihood_powheg.root
//////////////////////////////////////////////////////////

#ifndef plotMpresel_h
#define plotMpresel_h
...
#ifdef plotMpresel_cxx
plotMpresel::plotMpresel(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../b_likelihood_powheg_btag_b_presel_7jets.root");
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../b_likelihood_powheg_b_btag.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../b_likelihood_powheg_b_btag_presel_7jets.root");
      }
...
plotMpresel::~plotMpresel()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t plotMpresel::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t plotMpresel::LoadTree(Long64_t entry)
{
...
void plotMpresel::Init(TTree *tree)
{
...
void plotMpresel::Show(Long64_t entry)
{
...
Int_t plotMpresel::Cut(Long64_t entry)
{
