...
max_samples_num=18
input_dir=(WJetsToLNu)
#input_dir=(VBFHToBB_M-125_13TeV_powheg BTagCSV QCD_HT100to200 QCD_HT200to300 QCD_HT300to500 QCD_HT500to700 QCD_HT700to1000 QCD_HT1000to1500 QCD_HT1500to2000 QCD_HT2000toInf VBFHToBB_M-125_13TeV_powheg TTbar DYtoQQ ST_tW WJetsToLNu ttHtobb ttHtoNbb DYtoLL GF)
...
do	
	...
	qsub -q short.q batch2.sh $path${input_dir[ $current_sample ]}$v14$single$ROOT ${input_dir[ $current_sample ]} 1
