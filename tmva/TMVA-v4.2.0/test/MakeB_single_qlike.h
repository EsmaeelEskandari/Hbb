...
// Thu Aug 13 09:30:54 2015 by ROOT version 5.34/32
// from TTree tree/PhysicsTools.Heppy.analyzers.core.AutoFillTreeProducer.AutoFillTreeProducer_1
// found on file: ../../../Hbb/MC_new/VBFHToBB_M-125_13TeV_powheg_pythia8/tree.root
//////////////////////////////////////////////////////////

#ifndef MakeB_single_qlike_h
#define MakeB_single_qlike_h
...
public :
   ...
   MakeB_single_qlike(TTree *tree=0);
   virtual ~MakeB_single_qlike();
...
#ifdef MakeB_single_qlike_cxx
MakeB_single_qlike::MakeB_single_qlike(TTree *tree) : fChain(0) 
{
...
MakeB_single_qlike::~MakeB_single_qlike()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MakeB_single_qlike::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MakeB_single_qlike::LoadTree(Long64_t entry)
{
...
void MakeB_single_qlike::Init(TTree *tree)
{
...
Bool_t MakeB_single_qlike::Notify()
{
...
void MakeB_single_qlike::Show(Long64_t entry)
{
...
Int_t MakeB_single_qlike::Cut(Long64_t entry)
{
...
#endif // #ifdef MakeB_single_qlike_cxx
