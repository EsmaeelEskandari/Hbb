...
xrdfs t3se01.psi.ch mkdir -p /store/user/nchernya/Hbb/v21/workflow/$3_single
xrdcp $TMPDIR/$3_single/skimmed_tree_$2$root root://t3se01.psi.ch//store/user/nchernya/Hbb/v21/workflow/$3_single/
