...
// Sun Oct  4 11:22:37 2015 by ROOT version 5.34/32
...
#ifndef skim_trees_triggers_h
#define skim_trees_triggers_h
...
public :
   ...
   skim_trees_triggers(TTree *tree=0, TString filename = "");
   virtual ~skim_trees_triggers();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TString filename="tree.root", TString input_filename="", int trigger=0, int current_sample=1000, int data=0);
...
#ifdef skim_trees_triggers_cxx
skim_trees_triggers::skim_trees_triggers(TTree *tree, TString filename) : fChain(0) 
{
...
skim_trees_triggers::~skim_trees_triggers()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t skim_trees_triggers::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skim_trees_triggers::LoadTree(Long64_t entry)
{
...
void skim_trees_triggers::Init(TTree *tree)
{
...
Bool_t skim_trees_triggers::Notify()
{
...
void skim_trees_triggers::Show(Long64_t entry)
{
...
Int_t skim_trees_triggers::Cut(Long64_t entry)
{
...
#endif // #ifdef skim_trees_triggers_cxx
